...
# create certificates
openssl req -x509 -sha256 -nodes -days 365 -newkey rsa:2048 -keyout tls.key -out tls.crt -subj "/CN=keycloak.monarka.local/O=monarka"
k create secret tls keycloak-pki --key tls.key --cert tls.crt
